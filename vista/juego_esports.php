...
<body>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
        ...
        <p><input type="radio" name="esports" value = "As Dusk Falls"> As Dusk Falls</p>
        <p><input type="radio" name="esports" value = "God of War: Ragnarok"> God of War Ragnarök</p>
        <p><input type="radio" name="esports" value = "Return to Monkey Island"> Return to Monkey Island</p>
        <p><input type="radio" name="esports" value = "The Last Of Us Part I"> The Last Of Us Part I</p>
        <p><input type="radio" name="esports" value = "The Quarry"> The Quarry</p>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if($_REQUEST['esports'] !="") {
                ...
                if($id_us !="" && $id_juego !="") { //se comprueba que los dos id no estan vacios
                   try {
                        $sqlVot= $cons->query("SELECT id_votacion FROM votaciones WHERE categoria='mejor juego de esports' and id_usuario=$id_us"); //se comprueba si el usuario ya ha votado en sa categoria
                    ...
                    if($id_votacion == "" ){
                        try {
                            $sql= $cons->query("INSERT INTO votaciones (id_juego, id_usuario, categoria) VALUES ('$id_juego' , '$id_us', 'mejor juego de esports')"); //se añade la votacion a la tabla
                        } catch (Exception $e) {
                            echo "Se ha producido un error : " . $e->getMessage();
                        }
